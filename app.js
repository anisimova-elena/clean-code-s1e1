...
var editTask=function(){
    ...
    if(containsClass){
        ...
        label.classList.remove("task__title_edit");
        editBtn.innerText="Edit";
        editInput.classList.remove("task__input_edit");
    }else{
        editInput.value=label.innerText;
        label.classList.add("task__title_edit");
...
var taskCompleted=function(){
    ...
    taskLabel.classList.add('task__title_complete');
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    let taskLabel = listItem.querySelector('label');
    taskLabel.classList.remove('task__title_complete');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
